<?php
    ...
    class Friend{
        ...
        public function send_request($from_userid,$to_userid){
            ...
            $query = "insert into friend_requests (from_userid,to_userid,requested) select '$from_userid', '$to_userid', 1 where not exists (select * from friend_requests where from_userid='$from_userid' and to_userid='$to_userid')";
            $DB = new Database();
            $DB->save($query);
            return true;
        }
